...
public class QuestionController {
	...
	public ResponseEntity<?> addQuestion(@RequestBody Question question) {
		...
		if (question.getQuestionName().equals("") || question.getAnswer().equals("")) {
	...
	//to get questions of exam by examId
	@GetMapping("/exam/{id}/question")
	public List<Question> getQuestionsForExamByExamId(@PathVariable("id") int id){
		return this.questionRepository.findByExamNameId(id);
	}
