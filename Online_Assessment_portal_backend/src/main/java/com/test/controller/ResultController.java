...
public class ResultController {
	...
	public ResponseEntity<?> getResultByStudentEmail(@RequestParam("email") String email) {

		RestTemplate restTemplate = new RestTemplate();
		restTemplate.getForEntity("http://localhost:8082/api/user/user/{email}", User.class);
